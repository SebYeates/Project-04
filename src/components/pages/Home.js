  ...
  return (
    ...
    <section>
      <div>
        ...
        <Link className="hoverWrapper" to={'/companys'}><button className="button homesecond is-medium thumbnail"> Find A RYA Sailing School <i className="fas  homepage"></i> </button></Link>
